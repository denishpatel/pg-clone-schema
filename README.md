...
* This utility does not alter the contents within objects such as functions, procedures, triggers, etc). So any hard-coded schema references within them are not changed during the cloning process.
