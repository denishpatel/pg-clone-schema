...
CREATE TABLE sample.vectors3 (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    email1 public.citext NOT NULL,
    email2 public.citext NOT NULL,
    email3 text          NOT NULL DEFAULT 'aa@aaa.com',
    searchable tsvector GENERATED ALWAYS AS (to_tsvector('simple'::regconfig, COALESCE(public.translate(email1, '@.-'::public.citext, ' '::text), ''::text))) STORED NOT NULL,
